import { Box, Typography, Button, CircularProgress, Fade } from "@material-ui/core";
...
function CompositorV2(props) {
  ...
  const onCrop = () => {
    ...
    image.onload = () => {
      ...
      // }
      image = classifyIndexImage(image, fileImage.parentWidth, fileImage.parentWidth, false);
  ...
  return (
    <Fade in={fadeTransition} timeout={{ enter: fadeOutMs, exit: fadeOutMs }}>
      <Box>
        <WelcomeHeadline headline={"Proof of Index"} subText={"Show everyone that you're staked (3,3)."} />
          ...
          <Box display="flex" alignItems="center" className="module">
            <Box className="pof-box" style={{ width: "100%" }}>
              <Box
                ...
                style={
                  medScreen ? { flexFlow: "row-reverse" } : { flexFlow: "column", justifyContent: "space-between" }
                }
              >
                {/* Logo Resizing */}
                {uiStep === 3 && (
                  <Box id="stamper-box" style={{ width: rightSideContainerWidth() }}>
                    <LogoResizerV4
                      ...
                      containerHeight={objectFromScreenHeight() * 0.8}
                  ...
                  <div className="dropContainer" style={dropContainerStyle}>
                    <div id="dropzone-reg" {...getRootProps({ style: dropZoneReg })}>
                      ...
                      <Box className="dropzone-interior-container vertical-centered-flex">
                        ...
                        <Button id="upload-pfp-button" variant="contained" className="index-button">
                    ...
                    <Box display="flex" className="vertical-centered-flex">
                      ...
                      <Box display="flex" className="vertical-centered-flex">
                        ...
                        <Button
                          ...
                          variant="outlined"
                          className="outlined-index-button"
        ...
        {uiStep === 1 && (
          <Box className="two-btns-horizontal">
            <Button id="upload-pfp-button" variant="contained" className="index-button" onClick={goBackToRoot}>
        ...
        {uiStep === 2 && fileImage && (
          <Box className="two-btns-horizontal">
            <Button id="upload-pfp-button" variant="contained" className="index-button" onClick={goBackOneStep}>
              <Typography className="btn-text">Take Me Back Ser</Typography>
            </Button>
            <Button id="upload-pfp-button" variant="contained" className="index-button" onClick={goToStepThree}>
              <Typography className="btn-text">Confirm</Typography>
            </Button>
          </Box>
        )}
        {uiStep === 3 && <ShareOnTwitter inIndexCard={false} />}
      </Box>
    </Fade>
  );
}
